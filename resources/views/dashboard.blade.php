        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Bar Chart -->
              <canvas id="barChart" style="max-height: 400px; display: block; box-sizing: border-box; height: 199px; width: 399px;" width="599" height="299"></canvas>
              <script>
                document.addEventListener("DOMContentLoaded", () => {
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <!-- Bar Chart -->
              <canvas id="barChart2" style="max-height: 400px; display: block; box-sizing: border-box; height: 199px; width: 399px;" width="599" height="299"></canvas>
              <script>
                document.addEventListener("DOMContentLoaded", () => {
                  new Chart(document.querySelector('#barChart2'), {
                    type: 'bar',
                    data: {
                      labels: ['Subscription 1', 'Subscription 2', 'Third QuateSubscription 3', 'Subscription 4'],
                      datasets: [{
                        label: 'Bar Chart',
                        data: [65, 59, 80, 81],
                        backgroundColor: [
  ...
  <script>
    $(document).ready(function()  {
      ...
      $("#get_sales li a").click(function() {
        var time = $(this).text();
        var stat_type = 'sales';
        var site_url = $('#dashboard-stats-url').attr("data-statsurl")+'?time='+time+'&state_type='+stat_type;

          $('#sales_loader').html('<div class="spinner-border bb-spinner spinner-border-sm text-dark" role="status"><span class="visually-hidden">Loading...</span></div>');
      ...
      $("#get_revenue li a").click(function() {
        ...
        var site_url = $('#dashboard-stats-url').attr("data-statsurl")+'?time='+time+'&state_type='+stat_type;
          ...
          $('#revenue_loader').html('<div class="spinner-border bb-spinner spinner-border-sm text-dark" role="status"><span class="visually-hidden">Loading...</span></div>');
      ...
      $("#get_jobs li a").click(function() {
        ...
        var site_url = $('#dashboard-stats-url').attr("data-statsurl")+'?time='+time+'&state_type='+stat_type;
          ...
          $('#jobs_loader').html('<div class="spinner-border bb-spinner spinner-border-sm text-dark" role="status"><span class="visually-hidden">Loading...</span></div>');
