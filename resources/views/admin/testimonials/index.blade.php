  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item">Job Testimonials</li>
      <li class="breadcrumb-item active">Job Testimonials</li>
    </ol>
  </nav>
</div>
          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  @endphp
                  <td><img src="{{ $image }}" width="75" height="75"/></td>
                  ...
                  <td>
                      <a class="mx-1 text-success" href="{{ route('testimonials.edit', $record->id) }}"><i class="bi bi-pen"></i> </a>|
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form id="delete-form" action="{{ route('testimonials.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
