                        ...
                        <h5 class="card-title row">
                            ...
                            <div class="col-lg-6">
                                <div class="btn-group float-end" role="group" aria-label="Basic example">
                                    <a href="{{ route('countries.index') }}" class="btn btn-success">View all</a>
                                    <a href="{{ route('countries.create') }}" class="btn btn-success">Add new</a>
                                </div>
                            </div>
                        </h5>

                        <form method="POST" action="{{ route('countries.update', $record->id) }}" class="row g-3">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12">
                      ...
                      <input type="text" name="icon" value="{{ $record->icon }}" class="form-control" id="icon">
                            ...
                            <div class="col-md-12">
                                ...
                                <select class="form-control" name="status">
                                    <option value="enable" {{ $record->status == 'enable' ? 'selected' : '' }}>Enable
                                    </option>
                                    <option value="disable" {{ $record->status == 'disable' ? 'selected' : '' }}>Disable
                                    </option>
                                </select>
                            </div>
