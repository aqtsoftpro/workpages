...
<div class="pagetitle">
  ...
  <nav>
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item active">Manage Blog Categories</li>
    </ol>
  </nav>
</div>
            ...
            <h5 class="card-title row">
              ...
              <div class="col-lg-6">
                <div class="btn-group float-end" role="group" aria-label="Basic example">
                  <a href="{{ url('admin/blog_categories/create') }}" class="btn btn-success">Add new</a>
                </div>
              </div>
            </h5>
          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $record->slug }}</td>
                  <td>
                      <a class="mx-1 text-success" href="{{ route('blog_categories.edit', $record->id) }}"><i class="bi bi-pen"></i> </a>
                      |
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form id="delete-form" action="{{ route('blog_categories.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
