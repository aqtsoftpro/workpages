          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $record->slug }}</td>
                  <td>
                      <a class="mx-1 text-success" href="{{ route('manage_pages.edit', $record->id) }}"><i class="bi bi-pen"></i> </a>|
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form id="delete-form" action="{{ route('manage_pages.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
