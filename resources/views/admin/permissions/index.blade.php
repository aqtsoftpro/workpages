          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>{{ $record->name }}</td>
                  <td>{{ $record->permissionCategory->name ?? '' }}</td>
                  <td>
                      <a class="mx-1 text-success" href="{{ route('permissions.edit', $record->id) }}"><i class="bi bi-pen"></i> </a>|
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form id="delete-form" action="{{ route('permissions.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
