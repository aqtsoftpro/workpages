  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item">Job Skills</li>
          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                      <a class="mx-1 text-success" href="{{ route('skills.edit', $record->id) }}"><i class="bi bi-pen"></i> </a>|
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form id="delete-form" action="{{ route('skills.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
