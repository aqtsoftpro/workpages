  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item">Job Sector</li>
            ...
            <h5 class="card-title row">
              ...
              <div class="col-lg-6">
                <div class="btn-group float-end" role="group" aria-label="Basic example">
                  <a href="{{ url('admin/sectors') }}" class="btn btn-success">View all</a>
                ...
                <form method="POST"  action="{{ route('sectors.update',$record->id) }}" class="row g-3" >
