  ...
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item">Job Sectors</li>
      <li class="breadcrumb-item active">Job Sectors</li>
    </ol>
  </nav>
</div>
            ...
            <h5 class="card-title row">
              ...
              <div class="col-lg-6">
                <div class="btn-group float-end" role="group" aria-label="Basic example">
                  <a href="{{ url('admin/sectors/create') }}" class="btn btn-success">Add new</a>
                </div>
              </div>
            </h5>
          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                      <a class="mx-1 text-success" href="{{ route('sectors.edit', $record->id) }}"><i class="bi bi-pen"></i> </a>|
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form id="delete-form" action="{{ route('sectors.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
