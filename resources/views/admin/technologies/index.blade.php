...
@section('content')
<div class="pagetitle">
  <h1>Job Technologies</h1>
  <nav>
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Dashboard</a></li>
        <li class="breadcrumb-item">Job Technologies</li>
      <li class="breadcrumb-item active">Job Technologies</li>
    </ol>
  </nav>
</div>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title row">
              <div class="col-lg-6">
                View Job Technologies
              </div>
              <div class="col-lg-6">
                <div class="btn-group float-end" role="group" aria-label="Basic example">
                  <a href="{{ url('admin/technologies/create') }}" class="btn btn-success">Add new</a>
                </div>
              </div>
            </h5>
          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td>
                      <a class="mx-1 text-success" href="{{ route('technologies.edit', $record->id) }}"><i class="bi bi-pen"></i> </a>|
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-footer">
                              ...
                              <form id="delete-form" action="{{ route('technologies.destroy', $record->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
